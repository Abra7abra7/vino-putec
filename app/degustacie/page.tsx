          ...
          <div className="bg-background rounded-lg shadow-xl max-w-md w-full p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="text-wine-red hover:text-wine-dark text-2xl"
              >
                ×
              </button>
            </div>
            ...
            <div className="mb-4">
              <p className="text-wine-red font-semibold">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full border border-primary p-3 rounded focus:outline-none focus:ring-2 focus:ring-wine-red"
              ...
              <div>
                ...
                <select className="w-full border border-primary p-3 rounded focus:outline-none focus:ring-2 focus:ring-wine-red">
